...
class Args(BaseModel):
    ...
    epipolar_mask_weight_scale: float = 0.1
    ...
    test: bool = False
    generate_video_in_test: bool = False
    ...
    def parse_args(cls):
        ...
        # Epipolar
        parser.add_argument("--apply_epipolar_mask_weight", action="store_true")
        parser.add_argument("--epipolar_mask_weight_scale", type=float, default=0.0)
        ...
        parser.add_argument("--controlnetxs_model_path", type=str, default="")

        # Validation
        parser.add_argument("--do_validation", action="store_true")
        parser.add_argument("--test", action="store_true")
        parser.add_argument("--generate_video_in_test", action="store_true")
        parser.add_argument("--video_path_valid_list_file_path", type=str, default="")
